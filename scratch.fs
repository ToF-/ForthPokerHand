...
: HAND! ( a,b,c,d,e,addr -- )
    >R 5REVERSE R>
    5 0 DO TUCK I + C! LOOP DROP ;

: HAND@ ( addr -- a,b,c,d,e )
    5 0 DO DUP I + C@ SWAP LOOP DROP ;

: DISCARDS ( -- 0,1,0,2,...1,2,1,3..6,7 )
    6 0 DO 7 I 1+ DO I C, J C, LOOP LOOP ;

CREATE DISCARDSINDICES DISCARDS

CREATE CURRENTCARDS 7 ALLOT
CREATE POSSIBLEHANDS 5 21 * ALLOT

: 7CARDS! ( a,b,c,d,e,f,g,addr -- )
    7 0 DO TUCK I + C! LOOP DROP ;

: 7CARDS@ ( addr -- a,b,c,d,e,f,g )
    7 0 DO DUP I + C@ OVER LOOP DROP ;

: REMOVE2 ( a,b,c,d,e,f,g,x,y -- a,b,c,d,e )
    2>R R> ROLL DROP R> ROLL DROP ;

: POSSIBLEHAND ( addr,n -- a,b,c,d,e )
    2* DUP C@ SWAP 1+ C@
    2>R HAND@ 2R> REMOVE2 ;
...
: TESTSORTCARDS
    ...
    AS AD AC JC AD HAND .HAND CR
    AS QS 4D QH 4H HAND .HAND CR
;

: TESTDISCARDS
    DISCARDS
    21 0 DO . . SPACE SPACE LOOP ;

TESTSORTCARDS

CREATE MYHAND 5 ALLOT
AS QS 4D QH 4H HAND MYHAND HAND!
MYHAND HAND@ .HAND CR

TESTDISCARDS

AS QD 5C JC AD 3S 3H CURRENTCARDS 7CARDS!
CURRENTCARDS 7CARDS@ .S
